 ...
 * AI MODEL STORE
 *
 * Manages AI model selection and testing functionality.
 * Tracks selected model, test results, and provides model testing capabilities.
 *
 * Features:
 * - Zustand store with localStorage persistence
 * - Model selection and switching
 * - Connection testing for text and image capabilities
 * - Test result caching
 */
