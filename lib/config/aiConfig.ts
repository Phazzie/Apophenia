...
// This function is no longer needed as API keys are accessed directly in server-side modules
// export const getConfig = () => { ... }
// The API_KEYS object is also removed as it's no longer safe to expose on the client.
// Server-side modules will access process.env directly.
